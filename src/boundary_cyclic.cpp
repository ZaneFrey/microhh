...
namespace
{
    ...
    template<typename TF> __global__
    void boundary_cyclic_x_g(unsigned int* const __restrict__ data,
                             const int icells, const int jcells, const int kcells,
                             const int istart, const int jstart,
                             const int iend,   const int jend,
                             const int igc,    const int jgc)
    ...
    template<typename TF> __global__
    void boundary_cyclic_y_g(unsigned int* const __restrict__ data,
                             const int icells, const int jcells, const int kcells,
                             const int istart, const int jstart,
                             const int iend,   const int jend,
                             const int igc,    const int jgc)
...
template<typename TF>
void Boundary_cyclic<TF>::exec_2d_g(unsigned int* data)
{
    auto& gd = grid.get_grid_data();
